...
func (c *productServiceClient) GetProduct(ctx context.Context, in *GetProductReq, opts ...grpc.CallOption) (*ProductRes, error) {
...
func (c *productServiceClient) UpdateProduct(ctx context.Context, in *UpdateProductReq, opts ...grpc.CallOption) (*ProductRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductRes)
...
func (UnimplementedProductServiceServer) GetProduct(context.Context, *GetProductReq) (*ProductRes, error) {
...
func (UnimplementedProductServiceServer) UpdateProduct(context.Context, *UpdateProductReq) (*ProductRes, error) {
